...
from .models import User, ResearchArea, USER_TYPE
...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ('email', 'fullname', 'research_areas', 'user_type')
...
class CustomUserChangeForm(UserChangeForm):
    class Meta:
        model = User
        fields = ('email', 'fullname', 'research_areas', 'user_type', 'is_active', 'is_staff')