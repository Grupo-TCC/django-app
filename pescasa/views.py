...
from pescasa.forms import LoginForms, CustomUserCreationForm
        ...
        if 'register_submit' in request.POST:        
            ...
            if login_form.is_valid():
                ...
                if user is not None:
                    ...
                    return redirect('feed')  # Replace with your actual feed page URL name
                else:
                    messages.error(request, 'Email ou senha inválidos.')
    
    return render(request, 'pescasa/register.html', {
